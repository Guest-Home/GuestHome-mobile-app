        ...
        children: [
          Expanded(
            ...
            children: [
              ...
              ListTile(
                title: SecctionHeader(title: 'Stylish Guest House', isSeeMore: false),
                subtitle:SeeMoreText(text:'Lorem ipsum dolor sit amet consectetur. Purus elit susp endisse massa turpis et amet. Dignissim diam vel odio risus .Lorem ipsum dolor sit amet consectetur. Purus elit suspe ndisse massa turpis et amet. Dignissim   Readmore.',maxLines: 4,)
              ),
              Padding(
                ...
                child: Row(
                  ...
                  Text("Addis Ababa, Ayat",style: Theme.of(context).textTheme.bodyMedium,)
                ],),
              ),
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Row(
                  ...
                  children: [
                  CircleAvatar(),
                  Text("Posted by Yonas",style: Theme.of(context).textTheme.bodyMedium!.copyWith(fontWeight: FontWeight.bold),)
                ],),
              ),
              Card(
                ...
                elevation: 0,
                child: ListTile(
                  title: Text("Available facilities",style: Theme.of(context).textTheme.bodyLarge!.copyWith(fontWeight: FontWeight.bold),),
                  subtitle: Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Wrap(
                      spacing: 30,
            ...
            child: Row(
              ...
              children: [
                Row(
                  spacing: 10,
                  children: [
                  Text("200 ETB",style: Theme.of(context).textTheme.bodyLarge!.copyWith(fontWeight: FontWeight.w800),),
                  Text( "/per day")
                ],),
                ...
                ), child:Text("Book",style: Theme.of(context).textTheme.bodyLarge!.copyWith(color: Colors.white,fontWeight: FontWeight.w600),)))
              ],
            ),
          )
        ],
