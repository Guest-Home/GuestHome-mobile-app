...
class Booking extends StatelessWidget {
          ...
          Expanded(child: ListView(
            ...
            children: [
             SecctionHeader(title: "Booking", isSeeMore: false),
              ...
              CustomTextField(hintText: "first name", surfixIcon: null, onTextChnage:(value) {
              }, isMultiLine:false, textInputType:TextInputType.text),
              Padding(
                padding: const EdgeInsets.symmetric(vertical: 10),
                child: stepSutTitle(context, "Last Name", true),
              ),
              CustomTextField(hintText: "last name", surfixIcon: null, onTextChnage:(value) {
              }, isMultiLine:false, textInputType:TextInputType.text),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            CustomTextField(hintText:DateTime.now().month.toString(), surfixIcon:
                            GestureDetector(
                              onTap: () => showDatePicker(context: context,
                                  barrierColor: Colors.white,
                                  firstDate: DateTime.now(), lastDate:DateTime(2060)),
                                child: Icon(Icons.calendar_month,color: ColorConstant.secondBtnColor,)), onTextChnage:(value) {
                            }, isMultiLine:false, textInputType:TextInputType.text),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            CustomTextField(hintText:DateTime.now().month.toString(), surfixIcon: GestureDetector(
                                onTap: () => showDatePicker(context: context,
                                    barrierColor: Colors.white,
                                    firstDate: DateTime.now(), lastDate:DateTime(2060)),
                                child: Icon(Icons.calendar_month,color: ColorConstant.secondBtnColor,)), onTextChnage:(value) {
                ...
                mainAxisExtent:80
                    ...
                    itemBuilder:(context, index) => Card(
                      ...
                      child: RadioListTile.adaptive(
                        ...
                        title: Text("Passport",style: Theme.of(context).textTheme.bodyMedium,),
            ...
            child: Row(
              ...
              children: [
                Expanded(child: CustomButton(
                    ...
                    ), child:Text("Cancel",style: Theme.of(context).textTheme.bodyMedium!.copyWith(color: ColorConstant.secondBtnColor,fontWeight: FontWeight.w600),))
                ),
                Expanded(child: CustomButton(
                    onPressed: () {
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      padding: EdgeInsets.all(20),
                    ), child:Text("Confirm Booking",style: Theme.of(context).textTheme.bodyMedium!.copyWith(color: Colors.white,fontWeight: FontWeight.w600),))
                )
              ],
            ),
          )
  ...
  Future<dynamic> showBookedDialog(BuildContext context) {
    return showDialog(context: context, builder:(context) => AlertDialog(
                      backgroundColor: Colors.white,
                      title: Text("Book pending...",style: Theme.of(context).textTheme.headlineSmall!.copyWith(fontWeight: FontWeight.bold),),
                      icon: SvgPicture.asset('assets/icons/congrates.svg',
                      ...
                      content: SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text("You will get a call in a minute from the host or check booked menu for more information.",textAlign: TextAlign.center,),
                            Container(
                              width: MediaQuery.of(context).size.width,
                              margin: EdgeInsets.symmetric(horizontal: 20),
                              child: CustomButton(
                                onPressed: () {context.goNamed('booked');
                                },
                                  style:ElevatedButton.styleFrom(
                                backgroundColor: ColorConstant.primaryColor,
                                padding: EdgeInsets.all(15)
