...
class PopularHouseDetail extends StatefulWidget {
  const PopularHouseDetail({super.key, required this.property, required this.token,});
  final ResultEntity property;
  final String token;


  @override
  State<PopularHouseDetail> createState() => _PopularHouseDetailState();
}

class _PopularHouseDetailState extends State<PopularHouseDetail> {
  int photoIndex = 0;
  @override
