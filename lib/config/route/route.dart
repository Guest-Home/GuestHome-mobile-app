...
Future<GoRouter> createRouter() async {
  ...
  final GoRouter router = GoRouter(
    ...
    redirect: (context, state) async {
      ...
      String currentPath = state.uri.toString(); // Get the current route path
      final allowedPaths = [
        '/houseType',
        '/houseType/houseTypeDetail',
        '/houseType/houseTypeDetail/search',
        '/houseType/houseTypeDetail/houseGroupDetail',
      ];
      bool isAllowed = allowedPaths.any((path) => currentPath.startsWith(path));
